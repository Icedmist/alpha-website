...
import { LogOut, User, Lock, Mail, Phone, BookOpen, ShieldCheck, Zap, LayoutDashboard, Gift, BarChart, Users, ClipboardCheck, Award, Menu, X, FileText, Send } from "lucide-react";
            ...
            <div className="space-y-1">
              ...
              {currentUser.role === "admin" ? (
                <>
                  ...
                  <button 
                    onClick={() => handleTabClick("admin_partners")}
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11px] font-bold transition-all text-left cursor-pointer ${
                      activeTab === "admin_partners" 
                        ? "text-white bg-white/10" 
                        : "text-white/60 hover:text-white hover:bg-white/5"
                    }`}
                  >
                  ...
                  <button 
                    onClick={() => handleTabClick("admin_subscribers")}
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11px] font-bold transition-all text-left cursor-pointer ${
                      activeTab === "admin_subscribers" 
                        ? "text-white bg-white/10" 
                        : "text-white/60 hover:text-white hover:bg-white/5"
                    }`}
                  >
                ...
                <>
                  ...
                  <button 
                    onClick={() => handleTabClick("instructor_broadcast")}
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11px] font-bold transition-all text-left cursor-pointer ${
                      activeTab === "instructor_broadcast" 
                        ? "text-white bg-white/10" 
                        : "text-white/60 hover:text-white hover:bg-white/5"
                    }`}
                  >
